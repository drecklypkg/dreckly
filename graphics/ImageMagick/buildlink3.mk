# $NetBSD: buildlink3.mk,v 1.119 2024/11/24 06:59:05 adam Exp $
...
BUILDLINK_ABI_DEPENDS.ImageMagick+=	ImageMagick>=7.1.1.35nb7
...
.endif
.if ${PKG_BUILD_OPTIONS.ImageMagick:Mraqm}
